...
Client/File Daemon| [![Actions Status][build-client-img]][build-bareos-href]|![Size badge][size-latest-client-png]| ![Size badged][size-alpine-client-png]| [![Docker badge][docker-img-fd]][docker-url-fd]
